app_name = "crm"
app_title = "Gabriel Consultant CRM"
app_publisher = "Gabriel Consultant"
app_description = "Internal company CRM"
app_email = "thomas@gabriel.hk"
app_license = "AGPLv3"
...
doctype_js = {'CRM Lead': 'public/js/domain_enrichment.js',
...
doc_events = {'Contact': {'validate': ['crm.api.contact.validate']},
 'Notification Log': {'before_insert': ['crm.extends.notification_log.before_insert']},
 'ToDo': {'validate': ['crm.api.todo.validate'],
          'after_insert': ['crm.api.todo.after_insert'],
          'on_update': ['crm.api.todo.on_update']},
 'Communication': {'after_insert': ['crm.utils.on_communication_insert'],
                   'on_update': ['crm.utils.on_communication_update']},
 'Comment': {'after_insert': ['crm.utils.on_comment_insert'],
             'on_update': ['crm.api.comment.on_update']},
 'WhatsApp Message': {'validate': ['crm.api.whatsapp.validate'],
                      'on_update': ['crm.api.whatsapp.on_update']},
 'User': {'validate': ['crm.company_auth.validate_user']}}
...
standard_dropdown_items = [{'name1': 'settings',
  'label': 'Settings',
  'type': 'Route',
  'icon': 'settings',
  'route': '#',
 ...
 {'name1': 'about',
  ...
  'route': '#',
  'is_standard': 1},
 {'name1': 'separator', 'label': '', 'type': 'Separator', 'is_standard': 1},
 {'name1': 'logout',
  'label': 'Log out',
  'type': 'Route',
  'icon': 'log-out',
...
# Single-company authentication policy. The service Administrator remains CLI-only.
before_login = "crm.company_auth.before_login"
on_login = "crm.company_auth.on_login"
on_session_creation = "crm.company_auth.on_session_creation"
before_request = ["crm.company_auth.before_request"]
home_page = "company-login"
